...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    is_cold = temperature < 800
    has_high_neutron_flow = neutrons_emitted > 500
    has_low_output = temperature * neutrons_emitted < 500000
    return is_cold and has_high_neutron_flow and has_low_output
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    percent_value = temperature * neutrons_produced_per_second
    if percent_value < threshold * .9:
        return 'LOW'
    elif percent_value < threshold * 1.1:
        return 'NORMAL'
    else:
        return 'DANGER'
